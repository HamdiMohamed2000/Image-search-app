...
@AndroidEntryPoint
class GalleryFragment : Fragment(R.layout.fragment_gallery) , UnsplashPhotosAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            recyclerView.adapter = adapter.withLoadStateHeaderAndFooter(
                header = UnsplashPhotoLoadedStateAdapter { adapter.retry() },
                footer = UnsplashPhotoLoadedStateAdapter { adapter.retry() },
            )
